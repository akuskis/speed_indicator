...
double getCurrentSpeed()
{
    ...
    return (std::sin(ms.count() / 1000.) + 1) * 50 + (std::sin(ms.count() / 2000.) + 1) * 30
...
Java_com_example_speed_1indicator_service_DataServiceThread_startGenerator(JNIEnv* env, jobject obj)
{
